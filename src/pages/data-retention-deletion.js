...
export async function getServerSideProps(context) {
    ...
    const metaData = await getMetaData('/data-retention-deletion', pageUrl);
    return {
        props: {
...
export default function DataRetentionDeletionPolicy({ footerData, metaData }) {
    return (
        <>
            <MetaHeadComp metaData={metaData} page={'/data-retention-deletion'} />
            <Navbar footerData={footerData} utm={'/data-retention-deletion'} />
