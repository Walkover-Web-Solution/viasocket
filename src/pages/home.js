...
import { getFooterData, getIndexTemplateData , getReviewData} from '@/utils/getData';
import { FOOTER_FIELDS, INDEXTEMPLATE_FIELDS, REVIEWDATA_FIELDS } from '@/const/fields';
...
export async function getServerSideProps(context) {
    ...
    const reviewData = await getReviewData([], '', pageUrl);
