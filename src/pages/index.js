...
const HorizontalCardScroller = ({ items }) => {
    ...
    return (
        <div className="container relative w-full overflow-hidden group">
            ...
            <button
                onClick={() => scroll('left')}
                className="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-white text-black p-3 rounded-full shadow-lg hover-bg-white-text-black transition-all backdrop-blur-sm border border-gray-200"
            >
                ◀
            </button>
            <button
                onClick={() => scroll('right')}
                className="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-white text-black p-3 rounded-full shadow-lg hover-bg-white-text-black transition-all backdrop-blur-sm border border-gray-200"
            >
                ▶
            </button>
            ...
            >
                {displayedItems.map((item, index) => (
                    <div
                        ...
                        className="w-[300px] shadow-lg p-6 flex-shrink-0 border mx-2 hover-bg-white-text-black group bg-white"
                    >
