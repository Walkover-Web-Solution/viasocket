        ...
        <>
            ...
            <div className="add-background-color">
                <div className="w-full hero_gradint cont md:gap-20 sm:gap-16 gap-12">
                    ...
                    <div className="container cont border border-black text-center gap-2 bg-white py-5">
                    ...
                    <div className="container border border-black py-20 px-12 bg-white">
                        <div className="cont gap-2 text-center items-center">
                            <h2 className="h2">AI Agents That Work For You</h2>
                    ...
                    <div className="container cont border border-black gap-12 py-20 px-12 justify-center text-center items-center bg-white">
                        <div className="cont gap-2 text-center items-center">
                            <h2 className="h2 ">Be First in Line: Mobile App Early Access</h2>
