        ...
        <>
            <div className="min-h-screen">
                <div className="w-full grid grid-cols-1 lg:grid-cols-[1.05fr,1.4fr] min-h-screen">
                    ...
                    <div className="relative px-4 sm:px-8 lg:px-10 h-full py-10 flex flex-col items-center justify-center gap-8">
                        <div className="relative w-full max-w-xl sm:max-w-2xl lg:max-w-4xl bg-[#8a1a0b] text-white rounded-3xl space-y-8 flex justify-between flex-col px-6 sm:px-10 py-10 overflow-hidden gap-4">
                            <div
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/10 w-full max-w-xs sm:max-w-sm md:max-w-md ml-auto mt-4">
                                    <div className="flex items-start gap-4 flex-col">
                                        <div className="flex items-center gap-2">
                                            <Image
                                ...
                                <div className="flex flex-wrap items-end justify-between gap-6 text-sm !mt-20">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-2xl">{appCount}+</p>
                        ...
                        <div className="flex flex-col items-center justify-center gap-2">
                            <p className="text-base">Trusted by 4,000+ companies around the world</p>
