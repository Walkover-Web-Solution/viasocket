        ...
        <>
            ...
            <div className='global-top-space relative'>
                ...
                <div className="container cont pb-4 lg:gap-20 md:gap-16 gap-12 global-top-space">
                    ...
                    <div class="flex items-center justify-center border bg-white w-full max-w-[700px] mx-auto">
                        <div class="bg-white p-8 w-full border-t-8 border-[#a8200d] text-center">
                            <h2 class="text-gray-800 mb-2 h2 font-semibold">
                            ...
                            <p class="text-accent sub__h1 font-semibold">
                                Unlock 100+ More SaaS App Deals
                            </p></div>

                            <div class="text-black p-4 mb-8 text-center">
                                <p class="text-lg font-medium">Deals Unlocking On:</p>
                                <p class="text-4xl font-semibold mt-1">28<span class="text-3xl font-light align-top">th</span> Nov 2025</p>
                            </div>
                            ...
                            <Countdown
                                ...
                                renderer={({ days, hours, minutes, seconds }) => (
                                    <div className="flex justify-between text-center space-x-2 sm:space-x-4 mb-8 max-w-[600px] mx-auto">
                                        <div class="flex-1 bg-white p-3 border border-gray-200">
                                            <div class="text-4xl font-semibold text-gray-900 leading-none">{days}</div>
                                            <div class="text-xs uppercase text-gray-500 mt-1">DAYS</div>
                                        </div>

                                        <div class="flex-1 bg-white p-3 border border-gray-200">
                                            <div class="text-4xl font-semibold text-gray-900 leading-none">{hours}</div>
                                            <div class="text-xs uppercase text-gray-500 mt-1">HOURS</div>
                                        </div>

                                        <div class="flex-1 bg-white p-3 border border-gray-200">
                                            <div class="text-4xl font-semibold text-gray-900 leading-none">{minutes}</div>
                                            <div class="text-xs uppercase text-gray-500 mt-1">MINUTES</div>
                                        </div>

                                        <div class="flex-1 bg-white p-3 border border-gray-200">
                                            <div class="text-4xl font-semibold text-gray-900 leading-none">{seconds}</div>
                                            <div class="text-xs uppercase text-gray-500 mt-1">SECONDS</div>
                                        </div>
                                    </div>
                                )}
                            />
