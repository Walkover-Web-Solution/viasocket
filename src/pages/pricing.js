        ...
        <>
            ...
            <div className="container cont lg:gap-20 md:gap-16 gap-8">
                ...
                <div className="cont px-12 py-20 bg-white gap-4  border transparent-border-black">
                    <div className="flex flex-col gap-2">
                        <h2 className="h2">Start automating your way</h2>
                        <p className="sub__h1">
                            Build it yourself with the power of AI, or let experts build it for you. Either way,
                            viaSocket puts you in control.
                        </p>
                    </div>
