    ...
    return (
        <>
            ...
            <div className="container cont pb-4 lg:gap-24 gap-6">
                ...
                <div className="border transparent-border-black p-6 md:p-12 flex flex-col gap-6">
                ...
                <div className=" flex flex-col justify-center">
                    ...
                    <div className="flex flex-col lg:flex-row border transparent-border-black">
                ...
                <div className=" flex flex-col justify-center py-20">
                    <div className=" border border-t-0 transparent-border-black">
                ...
                <div className="cont lg:gap-36 md:gap-24 gap-12">
                    ...
                    <div>
                        <div className="flex flex-col transparent-border-black border border-b-0 p-6 md:p-12">
