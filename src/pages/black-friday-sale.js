...
const FallbackImage = ({ src, fallbackSrc, alt, ...props }) => {
    ...
    return <Image alt={alt} src={imgSrc} onError={() => setImgSrc(fallbackSrc)} {...props} />;
};
            ...
            <div className="global-top-space relative">
                <div className="flex items-center flex-col dotted-background h-auto pt-8 pb-16 sm:py-auto justify-center">
                    ...
                    <div className="flex flex-col items-center justify-center border custom-border p-4 mx-8 md:mx-16 sm:p-8 md:p-16 bg-[#faf9f6] text-center">
                        <p className="border bg-white rounded-full px-4 py-1 mb-2 max-w-[80%]">
                            {' '}
                            Top Handpicked Discounts & Lifetime Offers{' '}
                        </p>
                        <h1 className="text-6xl uppercase">
                            AI and SaaS Black Friday Deals <span className="text-accent">2025</span>
                        </h1>
                        <h2 className="text-2xl max-w-[600px]">
                            Discover the biggest AI and SaaS discounts of 2025. Updated daily with lifetime deals,
                            automation tools, marketing software, CRM, AI agents & more.
                        </h2>
                    </div>
                </div>
                ...
                <div className="dotted-background">
                    <div className="bg-black mb-4">
                        <Marquee speed={40} autoFill pauseOnHover={true}>
                    ...
                    <div className="bg-black">
                        <Marquee direction="right" speed={40} autoFill pauseOnHover={true}>
                ...
                <div className="container cont lg:py-20 md:py-16 py-12 lg:gap-20 md:gap-16 gap-12">
                    ...
                    <div className="grid md:grid-cols-[2fr_3fr] grid-cols-1 md:gap-12 gap-6 bg-white border custom-border">
                        <div className="flex flex-col justify-center items-start gap-4 p-6 md:p-12">
                            ...
                            <h3 className="h3">Free For Lifetime</h3>
                            <p>
                                Secure lifetime access to a complete automation platform with unlimited workflows and
                                task executions across {+appCount + 300}+ integrations.
                            </p>
                            <button
                            ...
                            {blackFridaySaleData?.map((item, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <Link
                                            href={`${normalizeUrl(item?.offerpricing_url)}?utm_source=viaSocket&utm_medium=listing&utm_campaign=blackfriday2025`}
                                            target="_blank"
                                            className="btn btn-accent w-full mx-auto mt-auto"
                                            onClick={() => {
