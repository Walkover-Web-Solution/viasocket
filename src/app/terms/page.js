...
export async function generateMetadata() {
    ...
    return {
        title: metaData?.title || 'Terms and Conditions - viaSocket',
        description: metaData?.description || 'Terms and conditions for using viaSocket services',
...
export default async function TermsPage() {
    const { metaData, footerData, navbarData } = await getTermsPageData();
            ...
            <div className="container mt-12 flex gap-16 flex-col global-top-space font-Arial">
                ...
                <div className="!bg-white p-12 border custom-border">
                    ...
                    <div className="space-y-4 py-8">
                        <p>We operate the website <a href="https://viasocket.com" target="_blank" className="link">
                            https://viasocket.com/
                        </a> (the '<strong>Site</strong>'), as well as any other related products and services that refer or link to these legal terms (the '<strong>Legal Terms</strong>') (collectively, the '<strong>Services</strong>').</p>

                        <p>viaSocket is a powerful workflow automation platform designed to streamline and automate repetitive tasks, enabling users to save time, reduce manual effort, and improve operational efficiency</p>

                        <p>You can contact us at our email <a href="mailto:support@viasocket.com" target="_blank" className="link">
                            support@viasocket.com
                        </a></p>

                        <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and viaSocket, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>

                        <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by support@viasocket.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
                    ...
                    <div>
                        ...
                        <div>
                            <ol className="list-decimal list-inside">
                                <a href="#services"><li className="link">OUR SERVICES</li></a>
                                <a href="#intellectual-property"><li className="link">INTELLECTUAL PROPERTY RIGHTS</li></a>
                                <a href="#user-representations"><li className="link">USER REPRESENTATIONS</li></a>
                                <a href="#user-registration"><li className="link">USER REGISTRATION</li></a>
                                <a href="#purchases-and-payment"><li className="link">PURCHASES AND PAYMENT</li></a>
                                <a href="#free-trial"><li className="link">FREE TRIAL</li></a>
                                <a href="#cancellation"><li className="link">CANCELLATION</li></a>
                                <a href="#refund-policy"><li className="link">REFUND POLICY</li></a>
                                <a href="#prohibited-activities"><li className="link">PROHIBITED ACTIVITIES</li></a>
                                <a href="#user-generated-contributions"><li className="link">USER GENERATED CONTRIBUTIONS</li></a>
                                <a href="#contribution-license"><li className="link">CONTRIBUTION LICENCE</li></a>
                                <a href="#guidelines-for-reviews"><li className="link">GUIDELINES FOR REVIEWS</li></a>
                                <a href="#social-media"><li className="link">SOCIAL MEDIA</li></a>
                                <a href="#third-party-websites"><li className="link">THIRD-PARTY WEBSITES AND CONTENT</li></a>
                                <a href="#services-management"><li className="link">SERVICES MANAGEMENT</li></a>
                                <a href="#privacy-policy"><li className="link">PRIVACY POLICY</li></a>
                                <a href="#term-and-termination"><li className="link">TERM AND TERMINATION</li></a>
                                <a href="#modifications-and-interruptions"><li className="link">MODIFICATIONS AND INTERRUPTIONS</li></a>
                                <a href="#governing-law"><li className="link">GOVERNING LAW</li></a>
                                <a href="#dispute-resolution"><li className="link">DISPUTE RESOLUTION</li></a>
                                <a href="#corrections"><li className="link">CORRECTIONS</li></a>
                                <a href="#disclaimer"><li className="link">DISCLAIMER</li></a>
                                <a href="#limitations-of-liability"><li className="link">LIMITATIONS OF LIABILITY</li></a>
                                <a href="#indemnification"><li className="link">INDEMNIFICATION</li></a>
                                <a href="#user-data"><li className="link">USER DATA</li></a>
                                <a href="#electronic-communications-transactions-and-signatures"><li className="link">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</li></a>
                                <a href="#california-users-and-residents"><li className="link">CALIFORNIA USERS AND RESIDENTS</li></a>
                                <a href="#miscellaneous"><li className="link">MISCELLANEOUS</li></a>
                                <a href="#contact-us"><li className="link">CONTACT US</li></a>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div className='py-8'>
                        ...
                        <div className='py-4' id="intellectual-property">
                            <div className="font-bold text-xl mb-4">
                            ...
                            <div className='space-y-4'>
                                ...
                                <div>Subject to your compliance with these Legal Terms, including the '<a href="#prohibited" className="link">PROHIBITED ACTIVITIES</a>' section below, we grant you a non-exclusive, non-transferable, revocable licence to:
                                ...
                                <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: support@viasocket.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                                ...
                                <p>Please review this section and the '<a href="#prohibited" className="link">PROHIBITED ACTIVITIES</a>' section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
                                ...
                                <p><strong>You are responsible for what you post or upload:</strong> By sending us Submissions through any part of the Services you:
                                    <ul className='list-disc'>
                                        <li>confirm that you have read and agree with our '<a href="#prohibited" className="link">PROHIBITED ACTIVITIES</a>' and will not post, send, publish, upload, or transmit through the Services any Submission that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
                        ...
                        <div className='py-4' id="user-registration">
                            <div className="font-bold text-xl mb-4">
                                4. USER REGISTRATION
                            </div>
                            <div className='space-y-4'>
                        ...
                        <div className='py-4' id="purchases-and-payment">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="free-trial">
                            <div className="font-bold text-xl mb-4">
                                6. FREE TRIAL
                            </div>
                            <div className='space-y-4'>
                        ...
                        <div className='py-4' id="cancellation">
                            <div className="font-bold text-xl mb-4">
                                7. CANCELLATION
                            </div>
                            <div className='space-y-4'>
                                ...
                                <p>If you are unsatisfied with our Services, please email us at support@viasocket.com or call us at +918818888758.</p>
                            </div>
                        </div>


                        <div className='py-4' id="refund-policy">
                            <div className="font-bold text-xl mb-4">
                                8. REFUND POLICY
                            </div>
                            <div className='space-y-4'>
                                ...
                                <p>• You may request a <strong>full refund of your subscription fee</strong> within <strong>7 days</strong> of purchase.<br />
                                ...
                                <p>Credits are consumed in real-time and often paid out to third-party providers (AI, messaging, developer tools, etc.). Because of this:</p>

                                <p>• Unused credits are fully refundable.<br />
                                    • Used credits are non-refundable.<br />
                                    • In case of partial usage, refunds will be issued only for the unused portion.</p>

                                <p><strong>Example:</strong><br />
                                    If you purchased 10,000 credits and used 3,000, the remaining 7,000 credits are eligible for refund.</p>

                                <p><strong>3. Failed or Erroneous Executions</strong></p>

                                <p>• If credits were deducted due to a <strong>system error</strong>, <strong>failed execution</strong>, or <strong>platform issue</strong>, those credits will be <strong>automatically or manually restored</strong>.<br />
                                    • If you believe credits were wrongly consumed, just reach out — we'll fix it.</p>

                                <p><strong>4. Abuse Protection (Rare, but Necessary)</strong></p>

                                <p>We reserve the right to deny refunds in cases of:</p>

                                <p>• Clear abuse of the refund policy<br />
                                    • Automated or malicious usage patterns<br />
                                    • Repeated refund requests after heavy usage</p>

                                <p>(We almost never need this clause — but it keeps the system honest.)</p>

                                <p><strong>5. How to Request a Refund</strong></p>

                                <p>Just email us at <strong><a href="mailto:support@viasocket.com">support@viasocket.com</a></strong><br />
                        ...
                        <div className="py-4" id="prohibited-activities">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="user-generated-contributions">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="contribution-licence">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="guidelines-for-reviews">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="social-media">
                            <div className="font-bold text-xl mb-4">
                                13. SOCIAL MEDIA
                            </div>
                            <div className='space-y-4'>
                        ...
                        <div className='py-4' id="third-party-websites">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="services-management">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="privacy-policy">
                            <div className="font-bold text-xl mb-4">
                                16. PRIVACY POLICY
                            </div>
                            <div className='space-y-4'>
                                <p>We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which is incorporated into these Legal Terms. Please be advised the Services are hosted in India, Singapore, Malaysia, Germany and Trinidad and Tobago. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, Singapore, Malaysia, Germany and Trinidad and Tobago, then through your continued use of the Services, you are transferring your data to India, Singapore, Malaysia, Germany and Trinidad and Tobago, and you expressly consent to have your data transferred to and processed in India, Singapore, Malaysia, Germany and Trinidad and Tobago.</p>
                            </div>
                        </div>
                        <div className='py-4' id="term-and-termination">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="modifications-and-interruptions">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="governing-law">
                            <div className="font-bold text-xl mb-4">
                                19. GOVERNING LAW
                            </div>
                            <div className='space-y-4'>
                                <p>These Legal Terms shall be governed by and defined following the laws of India. viaSocket and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
                                </p>
                            </div>
                        </div>

                        <div className='py-4' id="dispute-resolution">
                            <div className="font-bold text-xl mb-4">
                            ...
                            <div className='space-y-4'>
                                ...
                                <p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, or arbitration shall be indore, India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.</p>
                        ...
                        <div className='py-4' id="corrections">
                            <div className="font-bold text-xl mb-4">
                                21. CORRECTIONS
                            </div>
                            <div className='space-y-4'>
                        ...
                        <div className='py-4' id="limitations-of-liability">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="indemnification">
                            <div className="font-bold text-xl mb-4">
                                24. INDEMNIFICATION
                            </div>
                            <div className='space-y-4'>
                        ...
                        <div className='py-4' id="user-data">
                            <div className="font-bold text-xl mb-4">
                                25. USER DATA
                            </div>
                            <div className='space-y-4'>
                        ...
                        <div className='py-4' id="electronic-communications-transactions-and-signatures">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="california-users-and-residents">
                            <div className="font-bold text-xl mb-4">
                        ...
                        <div className='py-4' id="miscellaneous">
                            <div className="font-bold text-xl mb-4">
                                28. MISCELLANEOUS
                            </div>
                            <div className='space-y-4'>
                        ...
                        <div className='py-4' id="contact-us">
                            ...
                            <div className='space-y-4'>
                                ...
                                <p><span className='font-bold text-gray-600'>viaSocket</span><br />
                                    India<br />
                                    Phone: +918818888758<br />
                                    support@viasocket.com</p>
                                <p>These terms of use were created using Termly's <a href="https://termly.io/products/terms-and-conditions-generator" target='_blank'
                                    aria-label="privacy" className='link'>Terms and Conditions Generator</a>.</p>
                            </div>
                        </div>
