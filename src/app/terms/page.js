                ...
                <div className="!bg-white p-12 border custom-border">
                    ...
                    <div align="center" style={{ textAlign: 'left' }}>
                        ...
                        <div className="MsoNormal" style={{ textAlign: 'justify', lineHeight: '1.5' }}>
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    That said, ViaSocket includes both <strong>subscription access</strong> and{' '}
                                    <strong>usage-based credits</strong> (some of which are consumed via third-party
                                    services). To keep things fair for everyone, our refund policy is designed as
                                    follows:
                                </span>
                            </div>
                            <div className="MsoNormal" style={{ lineHeight: '1.5' }}>
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    • You may request a <strong>full refund of your subscription fee</strong> within{' '}
                                    <strong>7 days</strong> of purchase.
                                    <br />
                                    • No justification required.
                                    <br />• Refunds will be processed to the original payment method.
                                </span>
                            </div>
                            <div className="MsoNormal" style={{ lineHeight: '1.5' }}>
                                <br />
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    Credits are consumed in real-time and often paid out to third-party providers (AI,
                                    messaging, developer tools, etc.). Because of this:
                                </span>
                            </div>
                            <div className="MsoNormal" style={{ lineHeight: '1.5' }}>
                                <br />
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    ...
                                    <strong>Used credits are non-refundable</strong>.<br />• In case of partial usage,
                                    refunds will be issued <strong>only for the unused portion</strong>.
                                </span>
                            </div>
                            <div className="MsoNormal" style={{ lineHeight: '1.5' }}>
                                <br />
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    ...
                                    <br />
                                    If you purchased 10,000 credits and used 3,000, the remaining 7,000 credits are
                                    eligible for refund.
                                </span>
                            </div>
                            <div className="MsoNormal" style={{ lineHeight: '1.5' }}>
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    • If credits were deducted due to a <strong>system error</strong>,{' '}
                                    <strong>failed execution</strong>, or <strong>platform issue</strong>, those credits
                                    will be <strong>automatically or manually restored</strong>.<br />• If you believe
                                    credits were wrongly consumed, just reach out — we'll fix it.
                                </span>
                            </div>
                            <div className="MsoNormal" style={{ lineHeight: '1.5' }}>
                                <br />
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    • Clear abuse of the refund policy
                                    <br />
                                    • Automated or malicious usage patterns
                                    <br />• Repeated refund requests after heavy usage
                                </span>
                            </div>
                            <div className="MsoNormal" style={{ lineHeight: '1.5' }}>
                                <br />
                            ...
                            <div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
                                <span style={{ fontSize: '15px' }}>
                                    <strong>Our intent is simple:</strong>
                                    <br />
