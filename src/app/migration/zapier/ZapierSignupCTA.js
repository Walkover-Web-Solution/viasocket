...
// Zapier migration campaign tag. Every signup CTA on this page reports this source.
const ZAPIER_UTM_SOURCE = 'zapier-migration';
const SIGNUP_URL = `/signup?utm_source=${ZAPIER_UTM_SOURCE}`;

/**
 * Signup CTA for the Zapier migration page.
 *
 ...
 */
export default function ZapierSignupCTA({ className, children }) {
    const goToSignup = () => {
        setCookie('utmData', JSON.stringify({ utm_source: ZAPIER_UTM_SOURCE }), 1);
    ...
    return (
        <button
            ...
            className={className}
            onClick={goToSignup}
            data-track="migration_zapier_signup"
