    ...
    return (
        <>
            <div className="min-h-screen">
                <div
                    className="bg-white w-full grid grid-cols-1 lg:grid-cols-[1.05fr,1.4fr] min-h-screen"
                ...
                >
                        ...
                        <div className="space-y-8 flex flex-col">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="mt-4">
                                    ...
                                    <CustomLoginOptimized redirect_to={redirect_to} />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative px-4 sm:px-8 xl:px-16 h-full py-8 flex flex-col items-center justify-center gap-8 bg-[#FAF8F5]">
                        <div className="relative bg-[#8a1a0b] text-white rounded-3xl  flex justify-between flex-col px-6 sm:px-10 py-10 overflow-hidden gap-8 w-full lg:min-h-[80vh]">
                            <div
                                    ...
                                    {Array.from({ length: 5 }, (_, i) => (
                                        <span key={i}>
                                            <svg
                                                ...
                                                className="lucide lucide-star w-5 h-5 fill-white/90 text-white/90"
                                                aria-hidden="true"
                                            >
                            ...
                            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 shadow-xl border border-white/10 w-full max-w-xs sm:max-w-sm md:max-w-md ml-auto">
                                <div className="flex items-start gap-4 flex-col">
                                    ...
                                    <div className="space-y-2 text-sm leading-relaxed">
                                        <p className="text-white/90">
                                            viaSocket has been a big help for SaaSBoomi by making our workflows easier
                                            and improving how we deliver services.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex items-center flex-col gap-1">
                                        ...
                                        <span className="text-xs text-gray-600 flex items-center gap-2">
                                            {' '}
                                            <Image
                                                src="/review-image/capterra-logo.webp"
                                                width={16}
                                                height={16}
                                                alt="Capterra"
                                            />{' '}
