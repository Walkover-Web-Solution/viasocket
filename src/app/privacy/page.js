            ...
            <div className="container mb-4 mt-12 flex flex-col gap-16 global-top-space">
                ...
                <div className="border custom-border p-12 !bg-white">
                    <div className="text-gray-600 text-sm mb-4">
                        This privacy notice for viaSocket ("<strong>we,</strong> <strong>us,</strong> or{' '}
                        ...
                        <strong>Services</strong>"), such as when you: <br />
                        <ul className="list-type-square">
                            <li>
                                Visit our website at{' '}
                                <a href="https://viasocket.com" className="link">
                                    https://viasocket.com
                                </a>
                    ...
                    <div className="py-8">
                        <div className="font-bold text-2xl py-2 mb-4">SUMMARY OF KEY POINTS</div>
                        <div className="text-sm space-y-4">
                            ...
                            <p>
                                ...
                                <a
                                    href="https://app.termly.io/dsar/460fffde-6178-4b51-93d0-7f48ea5c93b9"
                                    target="_blank"
                                    className="link"
                                >
                        ...
                        <ol className="list-decimal list-inside">
                            <a href="#infocollect">
                                <li className="link">WHAT INFORMATION DO WE COLLECT?</li>
                            </a>
                            <a href="#infouse">
                                <li className="link">HOW DO WE PROCESS YOUR INFORMATION?</li>
                            </a>
                            <a href="#legalbases">
                                <li className="link">
                            ...
                            <a href="#sharing">
                                <li className="link">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</li>
                            </a>
                            <a href="#cookies">
                                <li className="link">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</li>
                            </a>
                            <a href="#thirdparty">
                                <li className="link">VIASOCKET THIRD PARTY INTEGRATIONS</li>
                            </a>
                            <a href="#sociallogins">
                                <li className="link">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</li>
                            </a>
                            <a href="#retention">
                                <li className="link">HOW LONG DO WE KEEP YOUR INFORMATION?</li>
                            </a>
                            <a href="#security">
                                <li className="link">HOW DO WE KEEP YOUR INFORMATION SAFE?</li>
                            </a>
                            <a href="#rights">
                                <li className="link">WHAT ARE YOUR PRIVACY RIGHTS?</li>
                            </a>
                            <a href="#dnt">
                                <li className="link">CONTROLS FOR DO-NOT-TRACK FEATURES</li>
                            </a>
                            <a href="#usresidents">
                                <li className="link">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</li>
                            </a>
                            <a href="#updates">
                                <li className="link">DO WE MAKE UPDATES TO THIS NOTICE?</li>
                            </a>
                            <a href="#contact">
                                <li className="link">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</li>
                            </a>
                            <a href="#review">
                                <li className="link">
                    ...
                    <div className="py-8">
                        <div className="py-4" id="infocollect">
                            <div className="font-bold text-xl mb-4">1. WHAT INFORMATION DO WE COLLECT?</div>
                            <div className="space-y-4">
                                <p className="font-bold" id="personalinfo">
                                    Personal information you disclose to us
                                </p>
                                <div className="text-sm text-gray-600 space-y-4">
                                    ...
                                    <p>
                                        We store basic account identification information such as first name, last name,
                                        email address, and profile image to facilitate user account creation,
                                        authentication, organizational mapping, and display within the platform
                                        interface.
                                    </p>

                                    <p>
                                        Such personally identifiable information (PII) is stored securely and protected
                                        using appropriate technical and organizational security measures, including
                                    ...
                                    <p>
                                        ...
                                        <a className="link" href="#sociallogins">
                        ...
                        <div className="py-4" id="infouse">
                            <div className="font-bold text-xl mb-4">2. HOW DO WE PROCESS YOUR INFORMATION?</div>
                                ...
                                <p>
                                    ...
                                    <ul className="list-type-square">
                                        <li>
                                            ...
                                            about{' '}
                                            <a className="link" href="#withdraw-consent">
                        ...
                        <div className="py-4" id="thirdparty">
                            <div className="font-bold text-xl mb-4">6. VIASOCKET THIRD PARTY INTEGRATIONS</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                                    <strong>In Short: </strong> viaSocket enables you to connect with third-party
                                    applications to automate workflows. This Privacy Policy explains how your data is
                                    handled when using these integrations. the extent local laws are applicable.
                                </p>
                                <p>
                                    <strong>Data Sharing</strong>
                                    <br />
                                    Only the data necessary to perform your configured workflows is shared with
                                    third-party services.
                                    <br />
                                    viaSocket does not sell, rent, or trade your data.
                                    <br />
                                    Data is transmitted securely and processed only to enable the services you
                                    configure.
                                </p>
                                ...
                                <p>
                                    ...
                                    <br />
                                    viaSocket uses YouTube API Services for certain integrations. When you use these
                                    features:
                                    <br />• You are agreeing to the{' '}
                                    <a className="link" href="https://www.youtube.com/t/terms" target="_blank">
                                        YouTube Terms of Service
                                    </a>
                                    <br />• You can review how Google handles your data in the{' '}
                                    <a
                                        className="link"
                                    ...
                                    <br />• You may revoke viaSocket's access to your YouTube data at any time via the{' '}
                                    <a
                                        className="link"
                                ...
                                <p>
                                    ...
                                    <br />
                                    Data is transmitted securely and only processed to enable the services you
                                    configure.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="py-4" id="sociallogins">
                            <div className="font-bold text-xl mb-4">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                        ...
                        <div className="py-4" id="retention">
                            <div className="font-bold text-xl mb-4">8. HOW LONG DO WE KEEP YOUR INFORMATION?</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                        ...
                        <div className="py-4" id="security">
                            <div className="font-bold text-xl mb-4">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                        ...
                        <div className="py-4" id="rights">
                            <div className="font-bold text-xl mb-4">10. WHAT ARE YOUR PRIVACY RIGHTS?</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                                ...
                                <p>
                                    ...
                                    or erasure; (iii) to restrict the processing of your personal information; (vi) if
                                    applicable, to data portability; and (vii) not to be subject to automated
                                ...
                                <p id="withdraw-consent">
                                    <span className="font-bold underline">Withdrawing your consent:</span> If we are
                                ...
                                <div className="font-bold text-xl mb-4">Account Information</div>
                                <p>
                                ...
                                <p>
                                    <span className="underline font-bold">Cookies and similar technologies: </span> Most
                        ...
                        <div className="py-4" id="dnt">
                            <div className="font-bold text-xl mb-4">11. CONTROLS FOR DO-NOT-TRACK FEATURES</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                        ...
                        <div className="py-4" id="usresidents">
                            ...
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                                    <strong> In Short:</strong> If you are a resident of , you are granted specific
                                ...
                                <div className="overflow-x-auto my-6">
                                    <table className="w-full border-collapse border border-gray-300">
                                        <thead>
                                            <tr>
                                                <th className="border border-gray-300 px-4 py-6 text-left font-semibold">
                                                    Category
                                                </th>
                                                <th className="border border-gray-300 px-4 py-6 text-left font-semibold">
                                                    Examples
                        ...
                        <div className="py-4" id="updates">
                            <div className="font-bold text-xl mb-4">13. DO WE MAKE UPDATES TO THIS NOTICE?</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
                        ...
                        <div className="py-4" id="contact">
                            <div className="font-bold text-xl mb-4">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</div>
                            <div className="space-y-4 text-sm text-gray-600">
                                <p>
