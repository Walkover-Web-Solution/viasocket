    ...
    return (
        <div className="animate-[hireStepFade_0.32s_cubic-bezier(0.2,0.7,0.2,1)]">
            ...
            <div className="mb-[18px]">
                ...
                />
                <p className="text-xs text-gray-500 mt-2">Tell us a bit about your workflow to get started.</p>
            </div>

            <button
                type="button"
                className="inline-flex items-center gap-2 px-3.5 py-2.5 bg-transparent border border-dashed border-[#e2e2e2] rounded-[10px] text-gray-500 text-xs font-medium hover:border-accent hover:text-accent hover:bg-[rgba(168,32,13,0.03)] transition-colors"
            >
