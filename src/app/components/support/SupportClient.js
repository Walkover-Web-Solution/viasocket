    ...
    return (
        <div className="container mt-12 global-top-space pt-12">
            <div className="support-page-heading">
                ...
                <p>
                    If you need anything, just reach out—we're committed to being the automation assistant you deserve!
                </p>
            </div>
                ...
                <div className="flex flex-col gap-6 p-6 border custom-border bg-white">
                    <div className="flex flex-col gap-1">
                        ...
                        <p>
                            ...
                            feedback that could help us improve, we want to hear from you. As the founders of viaSocket,
                            we’re always here to listen, solve problems, and continuously evolve to serve you better.
                            Don’t hesitate to reach out to us directly—we’re committed to making sure you get the best
                            experience possible.
                        </p>
                    </div>
