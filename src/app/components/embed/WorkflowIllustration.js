...
export default function WorkflowIllustration() {
    return (
        <div className="mt-auto flex items-center gap-3.5 pt-8">
            ...
            />
            <div className="flex-1 bg-white border border-[#e0d5ff] p-4 flex flex-col gap-[7px] rounded-md shadow-[0_4px_14px_rgba(124,58,237,0.1)]">
                <div className="flex items-center gap-2 text-base text-gray-700 font-medium leading-none animate-feat-item-pulse" style={{ animationDelay: '0s' }}>
                    <span className="text-gray-400 font-normal text-base min-w-[14px]">1.</span>
                    <span className="w-3.5 h-3.5 flex items-center justify-center shrink-0">
                        <User color="#ff7a59" size={12} />
                    </span>
                    Create Contact
                </div>
                <div className="flex items-center gap-2 text-base text-gray-700 font-medium leading-none animate-feat-item-pulse" style={{ animationDelay: '0.45s' }}>
                    <span className="text-gray-400 font-normal text-base min-w-[14px]">2.</span>
                    <span className="w-3.5 h-3.5 flex items-center justify-center shrink-0">
                        <Mail color="#ea4335" size={12} />
                    </span>
                    Send Email
                </div>
                <div className="flex items-center gap-2 text-base text-gray-700 font-medium leading-none animate-feat-item-pulse" style={{ animationDelay: '0.9s' }}>
                    <span className="text-gray-400 font-normal text-base min-w-[14px]">3.</span>
                    <span className="w-3.5 h-3.5 flex items-center justify-center shrink-0">
