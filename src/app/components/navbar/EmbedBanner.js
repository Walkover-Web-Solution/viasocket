...
export default function EmbedBanner() {
    return (
        ...
        >
            ...
            <Link href="/signup?utm_source=/embed" target="_blank" rel="nofollow noopener noreferrer" className='flex items-center gap-2 italic font-medium text-lg underline' data-track="banner_embed_signup" data-track-section="banner" data-track-action="signup_click">
