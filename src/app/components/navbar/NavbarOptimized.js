...
const current = normalizePath(currentPath || pathname);
    ...
    return (
        <>
            ...
            >
                {/* Top navigation bar */}
                <div className={`border-gray-300 border-b lg:block hidden ${isNavbarWhite ? 'bg-white supports-[backdrop-filter]:bg-[#ffffff]/60' : 'bg-[#f2f2ef] supports-[backdrop-filter]:bg-[#f2f2ef]/60'} backdrop-blur-xl`}>
                ...
                {/* Main navigation bar */}
                <div
                    className={`border-b border-gray-300 transition-all duration-300 ease-in-out overflow-hidden h-[48px] ${isNavbarWhite ? 'bg-white supports-[backdrop-filter]:bg-[#ffffff]/60' : 'bg-[#faf9f6]/80 supports-[backdrop-filter]:bg-[#faf9f6]/60'} backdrop-blur-xl`}
                >
