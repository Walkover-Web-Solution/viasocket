                        ...
                        <div className="flex items-center justify-center">
                            ...
                            {hasToken ? (
                                <button
                                    ...
                                    onClick={(e) => handleRedirect(e, pathname?.startsWith('/mcp') ? 'https://app.mushroom.viasocket.com/login?' : 'https://flow.viasocket.com?')}
                                    rel="nofollow"
                                >
                                ...
                                <button
                                    className={`${style.nav_btn} ${borderClass} flex items-center justify-center text-white px-4 mx-4 lg:mr-0 bg-accent h-full !text-xs text-nowrap hover:bg-black !h-[32px] !font-normal rounded-full`}
                                    onClick={(e) => handleRedirect(e, pathname?.startsWith('/mcp') ? 'https://app.mushroom.viasocket.com/login?' : '/signup?')}
                                >
                                    Login/Sign Up
                                </button>
                            )}
