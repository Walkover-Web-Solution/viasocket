...
export default function MigratingBanner() {
    return (
        ...
        >
            ...
            <Link href="/signup?utm_source=relay-switch-google-ads" target="_blank" rel="nofollow noopener noreferrer" data-track="banner_migration_signup" data-track-section="banner" data-track-action="signup_click">
