...
export default function EmbedSection({ appCount }) {
    const proofCards = [
        {
        ...
        },
        {
            ...
            desc: `Connect your chatbot or AI agent to ${appCount + 300}+ apps. Your AI doesn't just answer questions; it sends emails, creates tickets, and updates records.`,
        ...
        <div className="bg-[#1c1c1c] py-24">
            <div className="container flex lg:flex-row flex-col gap-12 items-center justify-between mb-6">
                <div className="flex-1 max-w-4xl">
                    ...
                    <h2 className="h2 mb-5 text-white">Your product, now with {appCount + 300}+ integrations</h2>
                ...
                <div className="flex-shrink-0 flex items-center justify-center">
                    <div className="w-[360px] h-[360px] md:w-[320px] md:h-[320px] relative" aria-hidden="true">
                        <div className="absolute top-1/2 left-1/2">
                            <div
                                className={`absolute rounded-full pointer-events-none w-[200px] h-[200px] -top-[100px] -left-[100px] md:w-60 md:h-60 md:-top-[120px] md:-left-[120px] border border-[rgba(220,90,90,0.65)] ${style.ring1}`}
                            />
                            <div
                                className={`absolute rounded-full pointer-events-none w-[280px] h-[280px] -top-[140px] -left-[140px] md:w-80 md:h-80 md:-top-40 md:-left-40 border border-[rgba(220,90,90,0.35)] ${style.ring2}`}
                            />
                            <div
                                className={`absolute rounded-full pointer-events-none w-[350px] h-[350px] -top-[175px] -left-[175px] md:w-[400px] md:h-[400px] md:-top-[200px] md:-left-[200px] border border-[rgba(220,90,90,0.15)] ${style.ring3}`}
                            />
            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {proofCards.map((card) => (
                        <div
                            key={card.title}
                            className="bg-[#272727] p-7 shadow-[0_2px_20px_rgba(0,0,0,0.35)] transition-all duration-200 ease-in-out"
                        >
