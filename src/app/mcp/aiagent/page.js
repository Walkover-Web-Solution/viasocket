...
export async function generateMetadata() {
    ...
    return {
        title: metaData?.title || 'MCP for AI Agents - viaSocket',
        description: metaData?.description || 'Connect your AI agents to 1000+ apps with MCP - viaSocket',
        keywords: metaData?.keywords || 'MCP, AI agents, integrations',
        openGraph: {
            title: metaData?.title || 'MCP for AI Agents - viaSocket',
            description: metaData?.description || 'Connect your AI agents to 1000+ apps with MCP - viaSocket',
...
export default async function MCPAiAgentPage() {
    const { footerData, faqData, metaData, blogData, navbarData } = await getMCPAiAgentPageData();
