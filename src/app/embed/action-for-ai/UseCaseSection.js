            ...
            <div className="grid md:grid-cols-[1fr_1.05fr] grid-cols-1 gap-14 md:gap-14 items-start">
                ...
                <div>
                    ...
                    <p className="text-[14.5px] text-gray-500 leading-[1.75] mb-[18px] font-normal">
                        Other platforms make you hard-wire every tool by hand. With Actions for AI, your agent reads the
                        situation and{' '}
                        <strong className="text-[#0a0a0a] font-bold">decides what to do on its own</strong> — no fixed
                        workflows, no prompt-engineered tool routing.
                    </p>
                    <p className="text-[14.5px] text-gray-500 leading-[1.75] mb-[18px] font-normal">
                ...
                <div className="bg-white border border-gray-200 shadow-sm">
                    ...
                    {/* Step 2 */}
                    <div className={`${styles.ucStep} flex gap-4 items-start px-6 py-5 border-b border-gray-200`}>
                        <div className={`${styles.ucStepIco} w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold bg-[#fef2f1] text-accent`}>AI</div>
                        <div className="flex-1 min-w-0">
                            <div className="text-[10.5px] font-bold tracking-wider uppercase text-gray-500 mb-[5px]">
                                Agent decision
                            </div>
                            ...
                            <div className="flex flex-col gap-[5px] mt-2">
                                {[
                                    ...
                                    <div key={item} className={`${styles.ucDecisionItem} flex items-center gap-2 text-xs text-gray-700 font-medium`}>
                    ...
                    <div className={`${styles.ucStep} flex gap-4 items-start px-6 py-5`}>
                        <div className={`${styles.ucStepIco} w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold bg-green-100 text-green-700`}>✓</div>
                        <div className="flex-1 min-w-0">
                            <div className="text-[10.5px] font-bold tracking-wider uppercase text-gray-500 mb-[5px]">
                                Executed
                            </div>
                            <div className="flex flex-col gap-1.5 mt-2">
                                {[
                                    ...
                                    <div key={app} className={`${styles.ucAction} flex items-center gap-2.5 px-[11px] py-[7px] bg-gray-50 border border-gray-200 text-xs flex-wrap`}>
                                        <span className="font-bold text-[#0a0a0a] min-w-[70px]">{app}</span>
                                        <span className="flex-1 text-gray-500 text-[11.5px]">{detail}</span>
                                        <span className={`${styles.ucActionStatus} text-[9.5px] font-bold text-green-700 bg-green-100 px-2 py-0.5 rounded-full tracking-wide`}>DONE</span>
                                    </div>
                                ))}
                            </div>
                        </div>
