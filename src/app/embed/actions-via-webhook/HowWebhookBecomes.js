...
const STEPS = [
    {
        ...
        alt: 'Send an event',
        title: 'Send an event',
        desc: 'Trigger a webhook whenever something happens in your app.',
    },
    {
        label: 'STEP 02',
        image: 'https://stuff.thingsofbrand.com/viasocket.com/images/img5_image-23.png',
        alt: 'Send it to your webhook',
        title: 'Send it to your webhook',
        desc: 'Post the event payload to your unique webhook URL.',
    },
    {
        label: 'STEP 03',
        image: 'https://stuff.thingsofbrand.com/viasocket.com/images/imge_image-24.png',
        alt: 'Your Integrations run',
        title: 'Your Integrations run',
        desc: 'Your connected apps take action automatically based on the event.',
    },
];

export default function HowWebhookBecomes() {
    return (
