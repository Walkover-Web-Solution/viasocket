...
export async function generateMetadata() {
    const { metaData } = await getDataDeletionPolicyPageData();

    return {
        title: metaData?.title || 'Data Deletion Policy - viaSocket',
        description: metaData?.description || 'Data Deletion Policy - viaSocket',
...
export default async function DataDeletionPolicyPage() {
    const { footerData, metaData, navbarData } = await getDataDeletionPolicyPageData();

    return (
        <>
            <MetaHeadComp metaData={metaData} page={'/data-deletion-policy'} />
            <NavbarOptimized navbarData={navbarData} utm={'/data-deletion-policy'} />
