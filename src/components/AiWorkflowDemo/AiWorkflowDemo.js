...
export default function AiWorkflowDemo({ compact = false }) {
    ...
    return (
        <div
            ref={windowRef}
            className="bg-white rounded-[18px] border border-black/[0.08] shadow-[0_2px_4px_rgba(0,0,0,0.04),0_10px_36px_rgba(0,0,0,0.08),0_28px_72px_rgba(0,0,0,0.05)] overflow-hidden text-left flex flex-col aiwf-float"
        >
            {/* Chrome */}
