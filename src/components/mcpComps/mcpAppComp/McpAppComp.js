                ...
                <div className="cont gap-8">
                    ...
                    <div className="container flex flex-col lg:flex-row gap-8 lg:gap-12">
                        <div className="cont cont__py  gap-16 w-full lg:w-1/2">
                            ...
                            >
                                <button className="btn border-0 bg-accent text-white hover-bg-white-text-black">
                                    Get Your MCP URL
                                </button>
                            </Link>
                        </div>
                        <div className="w-full lg:w-1/2 py-0 lg:py-12 px-0 sm:px-20 lg:px-0 xl:px-20">
                            <div className="border bg-white shadow-lg h-full cont gap-4 md:gap-12 py-2 md:py-8 px-2 sm:px-12">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="cont justify-between gap-2">
                                        ...
                                        <div className="cont gap-1">
                                            ...
                                            <div className="border transparent-border-black bg-gray-200 px-4 py-2 shadow-md cont gap-2">
                                ...
                                <div className="border transparent-border-black px-8 py-4 flex justify-between">
                                ...
                                ?.map((app, index) => {
                                    return (
                                        <Link
                                            key={index}
                                            href={createURL(`/mcp/${app?.appslugname}`)}
                                            className="flex flex-col sm:py-9 py-6 sm:px-6 px-4 transparent-border-black border border-l-0 border-t-0 gap-2 hover:text-white hover:bg-black bg-white hover-bg-white-text-black"
                                        >
                                            <div className="flex items-center gap-2">
                                                <div className="border flex items-center justify-center w-9 h-9">
                                                    <Image
                        ...
                        <div className="flex justify-end items-center w-full py-4">
                            <div className="flex gap-4">
                                {integrationsInfo?.page > 0 && (
                                    <Link
                                        className="border transparent-border-black px-6 py-2 flex items-center gap-2 hover-bg-white-text-black transition-colors font-medium"
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {appOneDetails?.category?.slice(0, 2).map((cat, index) => (
                                        <Link
                                            ...
                                            className="mb-2"
                                        >
                                            <span className="px-3 text-sm py-2 text-white hover-bg-white-text-black bg-accent ">
                                                {cat}
                                            </span>
                                        </Link>
                                    ))}
                            ...
                            <div className="w-full cont gap-4 p-12 border-x md:border-l-0 transparent-border-black">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <Link href="/mcp" className="mb-2">
                                        <span className="px-3 py-2 text-sm text-white hover-bg-white-text-black bg-accent">
                                            viaSocket MCP
                                        </span>
                                    </Link>
