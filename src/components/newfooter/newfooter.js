...
const NewFooter = ({ footerData, borderClass }) => {
    ...
    return (
        <>
            <div
                className={`grid lg:grid-rows-1 md:grid-cols-2 lg:grid-cols-4 grid-rows-1  ms:grid-cols-4 grid-cols-1 border  !border-gray-300 ${borderClass}`}
            >
                <div className="row-span-1 col-span-4 lg:col-span-1 order-last lg:order-first md:p-10 p-4  lg:border-r border-r-0 !border-gray-300">
                ...
                <div className=" row-span-1 col-span-4 lg:col-span-3 grid sm:grid-cols-3 grid-cols-1">
                    <div className="flex flex-col gap-8 md:p-10 p-4 lg:border-b-0  border-b sm:border-r !border-gray-300">
                        {renderedGroups.slice(0, 2)}
                    </div>

                    <div className="flex flex-col gap-8 md:p-10 p-4 sm:border-r lg:border-b-0  border-b !border-gray-300">
                        {renderedGroups.slice(2, 4)}
                    </div>

                    <div className="flex flex-col lg:border-b-0 border-b !border-gray-300 gap-8 md:p-10 p-4 ">
