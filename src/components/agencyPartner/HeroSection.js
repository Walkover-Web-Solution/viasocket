...
export default function HeroSection({
  ...
  primaryCta = { label: 'Become a Partner', href: 'https://tally.so/r/3NaYMp', external: true },
  secondaryCta = { label: 'Talk to Sales', href: '#' },
  trustLabel = 'Trusted by 50+ automation agencies worldwide',
}) {
        ...
        <>
          ...
          <span className="relative inline-block">
            <span
              ...
              style={{
                background: 'radial-gradient(circle at center, rgba(168, 32, 13, 0.05) 0%, rgba(168, 32, 13, 0.03) 40%, transparent 72%)',
                filter: 'blur(300px)',
              }}
            />
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div
          ...
          style={{
            ...
            background: 'radial-gradient(circle, rgba(168, 32, 13, 0.08) 0%, rgba(168, 32, 13, 0.03) 35%, transparent 70%)',
            filter: 'blur(40px)',
          }}
        />
      </div>
        ...
        <div className="flex flex-col md:flex-row flex-wrap items-center justify-center gap-4 md:gap-5 mb-14">
          ...
          {secondaryCta && (
            <a
              ...
              className="group inline-flex items-center gap-[6px] text-[15px] font-medium text-[#222] no-underline transition-colors duration-200 hover:text-[#a8200d]"
            >
              {secondaryCta.label}{' '}
