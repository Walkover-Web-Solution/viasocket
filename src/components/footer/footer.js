...
export default function Footer({ footerData, borderClass, isBlack = false }) {
    ...
    return (
        <>
            <div
                className={`bg-white grid lg:grid-rows-1 md:grid-cols-2 lg:grid-cols-4 grid-rows-1  ms:grid-cols-4 grid-cols-1 border container border-${borderTheme} ${borderClass}`}
            >
                <div
