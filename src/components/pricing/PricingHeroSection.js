...
export default function PricingHeroSection() {
    return (
        <section className="bg-white">
            <div className="container p-12 mt-12 md:mt-0 flex flex-col gap-10 items-center justify-center global-top-space min-h-screen">
                    ...
                    <div className="flex items-center gap-2 bg-yellow-50 px-4 py-2 rounded-full border border-yellow-50 w-fit">
                        <div className="flex gap-0.5">
                            ...
                            <span className="relative text-xs text-gray-300">
                                ★<span className="absolute left-0 top-0 text-yellow-400 overflow-hidden w-1/2">★</span>
                            </span>
                        </div>
                ...
                <div className="w-full relative z-10 mt-16">
                    <div className="bg-gradient-to-r from-yellow-50 to-yellow-50 rounded-2xl p-6 md:p-8 flex flex-wrap items-center justify-center gap-6 md:gap-12">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="font-semibold text-accent text-xl">2200+</span>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="font-semibold text-accent text-xl">10M+</span>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="font-semibold text-accent text-xl">99.9%</span>
