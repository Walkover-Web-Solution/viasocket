                ...
                >
                    <div className="justify-between items-center flex px-4 h-[48px]">
                        ...
                        <div className="flex items-center justify-center">
                            ...
                            {hasToken ? (
                                <button
                                    className={`${style.nav_btn} ${borderClass} flex items-center justify-center text-white px-2 mx-4 lg:mr-0 bg-accent h-full !text-xs text-nowrap hover:bg-black !h-[32px] !font-normal rounded-full`}
