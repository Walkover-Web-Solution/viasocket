...
const TemplateCard = ({ template, preventClick, isFeatured }) => {
    ...
    return (
        ...
        >
            {isFeatured && (
                <div className="absolute top-3 right-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg z-10 flex items-center gap-1">
